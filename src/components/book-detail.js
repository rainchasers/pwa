      ...
      <section ?hidden="${_showOffline}">
        <div class="info">
          ...
          <div class="info-desc">
            ...
            <div class="info-item" ?hidden="${!author}">
              ${author} - ${date}
            </div>
            <div class="info-item" ?hidden="${!pageCount}" desktop>
              ${pageCount} pages
            </div>
            <div class="info-item" ?hidden="${!publisher}" desktop>
              ${publisher} - publisher
            </div>
            <div class="flex"></div>
            <div
            ...
            >
              <button
                class="fav-button"
                @click="${() =>
                  store.dispatch(saveFavorite(_item, isFavorite))}"
                ?hidden="${!_isSignedIn}"
              >
            ...
            <div class="preview-btn-container">
              <a
                href="/viewer/${_item.id}"
                class="book-button"
                ?hidden="${!accessInfo.embeddable}"
                >PREVIEW</a
              >
            </div>
          </div>
        ...
        <div class="rating-container">
          ...
          <span
            >(${ratingsCount || 0}
            ${ratingsCount == 1 ? "review" : "reviews"})</span
          >
        </div>
        <div class="desc">
          <h3>Description</h3>
